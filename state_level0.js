...
function p_0() {
    ...
    //new tile
    game.load.tilemap('castle_map','assets/tilemap/tilemap9_spikes.json',null, Phaser.Tilemap.TILED_JSON);
...
function u_0() {
    ...
    seconds_st0 = Math.round(game.timer.seconds*10)/10 + seconds - .7;
    ...
    if(pHealth <= 0 && !pFlinchToLDS.isPlaying && !pFlinchToRDS.isPlaying) {
        game.score = -2000;
